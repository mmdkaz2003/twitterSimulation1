...
public class CreateNormalAccountController {
    ...
    public void createAccount(MouseEvent mouseEvent){
        if(accountName.getText()!=null&&accountUserName.getText()!=null&&accountPassWord.getText()!=null
                &&accountRepeatedPassWord.getText()!=null&&accountSecurityQ.getText()!=null&&accountBirthDay.getValue()!=null){
            ...
            LocalDate birthDay=accountBirthDay.getValue();
            if(userName==null){
                ...
                try {
                    ...
                    preparedStatement.setString(5, "NormalAccount");
